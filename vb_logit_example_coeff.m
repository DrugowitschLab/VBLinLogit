...
plot(w - 0.02, w_VB1, 's', 'MarkerSize', 3, ...
     'MarkerFaceColor', [0.8 0 0.8], 'MarkerEdgeColor', 'none');
plot(w, w_LD, '+', 'MarkerSize', 3, ...
...
plot(xlim, -(w(1) + w(2)*xlim) / w(3), 'k-', 'LineWidth', 1);
plot(xlim, -(w_LD(1) + w_LD(2)*xlim) / w_LD(3), '-', ...
    'LineWidth', 1, 'Color', [0 0 0.8]);
plot(xlim, -(w_VB(1) + w_VB(2)*xlim) / w_VB(3), '-', ...
    'LineWidth', 1, 'Color', [0.8 0 0]);
plot(xlim, -(w_VB1(1) + w_VB1(2)*xlim) / w_VB1(3), '-', ...
