function vb_linear_fit_ard_test()
...
fprintf('Testing vb_linear_fit_ard(.)\n');
...
X = genX(N_small);
y = genY(X);
[w1, V1] = vb_linear_fit_ard(X, y);
[w2, V2] = vb_linear_fit_ard(X, y, a0);
[w3, V3] = vb_linear_fit_ard(X, y, a0, b0);
[w4, V4] = vb_linear_fit_ard(X, y, a0, b0, c0);
[w5, V5] = vb_linear_fit_ard(X, y, a0, b0, c0, d0);
